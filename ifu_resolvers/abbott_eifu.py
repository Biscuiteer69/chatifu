...
class AbbottEifuResolver:
    """Adapter around Abbott's public manuals.eifu.abbott search API."""
    ...
    def can_handle(
        ...
        return "abbott" in text or "manuals.eifu.abbott" in text
    ...
    def resolve(
        ...
        if not document_url:
            AbbottResolver(db_path=self.db_path).resolve(
                catalog,
